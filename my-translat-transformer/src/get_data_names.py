...
# data_path = '/home/rohit/Documents/Research/Planning_with_transformers/Translation_transformer/my-translat-transformer/data/DG3/raw_data/'
# data_path = '/media/HDD/rohit/Translation_transformer/my-translat-transformer/data/Perlin/'
